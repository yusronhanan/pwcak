				...
				<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="#about" class="hvr-underline-from-center scroll">Courses</a></li>
								...
								<li><a href="#contact" class="hvr-underline-from-center scroll">MyAccount</a></li>
							</ul>
						</div>
						<div class="clearfix"> </div>	
				</nav>
...
<div class="services" id="services">
		...
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="assets/images/book.png" alt=" " /></a>
			</div>
			<h4>Service 1</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="assets/images/edu.png" alt=" " /></a>
			</div>
			<h4>Service 2</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="assets/images/uni.png" alt=" " /></a>
			</div>
			<h4>Service 3</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="assets/images/hourglass.png" alt=" " /></a>
			</div>
			<h4>Service 4</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="assets/images/book2.png" alt=" " /></a>
			</div>
			<h4>Service 5</h4>
			<p>Lorem Ipsum</p>
		</div>
		...
		<div class="portfolio-top wow fadeInDown animated" data-wow-delay=".5s">
			...
			<div class="col-md-4 grid slideanim">
				...
				<a href="#portfolioModal1"  data-toggle="modal">
					...
					<img src="assets/images/g1.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4>Educational</h4>
			...
			<div class="col-md-4 grid slideanim">
				...
				<a href="#portfolioModal2"  data-toggle="modal">
					...
					<img src="assets/images/g2.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4>Educational</h4>
							<p> Education is not a problem. Education is an opportunity.</p>							
						</figcaption>	
			...
			<div class="col-md-4 grid slideanim">
				...
				<a href="#portfolioModal3"  data-toggle="modal">
					...
					<img src="assets/images/g3.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4>Educational</h4>
							<p> Education is not a problem. Education is an opportunity.</p>							
						</figcaption>
		...
		<div class="portfolio-top wow fadeInUp animated" data-wow-delay=".5s">
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal4"  data-toggle="modal">
					...
					<img src="assets/images/g4.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
			...
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal5"  data-toggle="modal">
					...
					<img src="assets/images/g5.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4 class="effcet-text"> Educational</h4>
							<p>Learning is never done without errors and defeat.</p>							
						</figcaption>
			...
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal6"  data-toggle="modal">
					...
					<img src="assets/images/g6.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4 class="effcet-text">Educational</h4>
							<p>Learning is never done without errors and defeat.</p>							
						</figcaption>
			...
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal7"  data-toggle="modal">
					...
					<img src="assets/images/g7.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4 class="effcet-text"> Educational</h4>
							<p> Learning is never done without errors and defeat.</p>							
						</figcaption>
